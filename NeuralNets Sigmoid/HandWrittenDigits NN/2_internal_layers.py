...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        for w, b in zip(self.weights, self.biases):
            # a0 = LAYER 0 --> INPUT
            # a1 = LAYER 1 --> 549 neurons --> sigmoid( np.dot( w a0 ) + b ) --> np.dot ( w(549,784), a(784,1) ) + b(549,1) == a(549, 1)
            # a2 = LAYER 2 --> 235 neurons --> sigmoid( np.dot( w a1 ) + b ) --> np.dot ( w(235,549), a(549,1) ) + b(235,1) == a(235, 1)
            # a3 = LAYER 3 OR result --> 10 neurons --> sigmoid( np.dot( w a2 ) + b ) --> np.dot ( w(10,235), a(235,1) ) + b(10,1) == a(10,1)
        ...
        # Back filling by taking derivative at each layer
...
def main():
    ...
    net.stochastic_gradient_descend(training_dataset_zip, 100, 10, 3, testing_dataset_zipped)
